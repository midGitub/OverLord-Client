...
#endif
		_GT (typeof(WWWForm)),//kyx 2016/07/22
...
_GT(typeof(UseWindow1)),
_GT(typeof(UseHero1)),
_GT(typeof(GameTimes)),
    ...
    //需要打包的assetbundle信息
    public static List<string[]> abList = new List<string[]>
    {
        new string[3]{"Bullet","*.prefab","Assets/Bundle/Prefabs/Bullet"},
        new string[3]{"LifeBar","*.prefab","Assets/Bundle/Prefabs/LifeBar"},      
        //FGUI
        new string[3]{"loading","*.*","Assets/Bundle/FGUI/LoadingUI"},
        new string[3]{"login","*.*","Assets/Bundle/FGUI/LoginUI"},      
        new string[3]{"register","*.*","Assets/Bundle/FGUI/RegisterUI"},      
        new string[3]{"main","*.*","Assets/Bundle/FGUI/MainUI"},      
        new string[3]{"hero","*.*","Assets/Bundle/FGUI/HeroUI"},      
