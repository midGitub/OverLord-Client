...
public class Packager {
    ...
    public static void BuildAssetResource(BuildTarget target) {
        ...
        foreach (var item in CustomSettings.abList)
        {
            Util.Log(item[0]+"," + AppConst.ExtName+"," +item[1]+","+ item[2]);
            AddBuildMap(item[0] + AppConst.ExtName, item[1], item[2]);
        }
    ...
    static void HandleExampleBundle() {
        ...
        //将FGUI打包成assetsbundle
        //AddBuildMap("loading" + AppConst.ExtName, "*.*", "Assets/Resources/FGUI/LoadingUI");
		//AddBuildMap("login" + AppConst.ExtName, "*.*", "Assets/Resources/FGUI/LoginUI");
		//AddBuildMap("register" + AppConst.ExtName, "*.*", "Assets/Resources/FGUI/RegisterUI");
        //AddBuildMap("main" + AppConst.ExtName, "*.*", "Assets/Resources/FGUI/MainUI");
        //AddBuildMap("hero" + AppConst.ExtName, "*.*", "Assets/Resources/FGUI/HeroUI");
    }
