...
public class SocketClient
{
    ...
    void OnDisconnected(DisType dis, string msg)
    {
        ...
        NetworkManager.AddEvent(protocal, buffer.ToString());
    ...
    void OnReceivedMessage(MemoryStream ms)
    {
        ...
        NetworkManager.AddEvent(mainId, buffer.ToString());
    }
...
////----------------------------------------原版LuaFramework.SocketClient------------start---------------------------------------------------------------------
//using UnityEngine;
//using System;
//using System.IO;
//using System.Net;
...
//    }
//}
//----------------------------------------原版LuaFramework.SocketClient------------end---------------------------------------------------------------------